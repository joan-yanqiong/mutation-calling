include {TUMOR_REALIGN_PREPROCESS; NORMAL_REALIGN_PREPROCESS; TUMOR_HISAT_ALIGN; PAIR_HISAT_ALIGN; MUTECT_R2 ; INDEX_BAM_HIS_NORMAL; INDEX_BAM_HIS_TUMOR; SORT_BAM_COORD_HIS_NORMAL; SORT_BAM_COORD_HIS_TUMOR; ANNOVAR;FILTERING;CONVERT_TO_AVINPUT} from "../nf-modules/rna_mutect2"
...
workflow RNA_MUTECT {
  ...
  | splitCsv(header:true) \
  | map { row -> tuple(row.normal_id, row.ix, row.normal_id) }
